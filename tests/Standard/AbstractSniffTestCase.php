...
namespace Jgut\ECS\Fixer\Tests\Standard;
...
abstract class AbstractSniffTestCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->standardsDir = __DIR__ . '/../../src/Standard';
    }
    ...
    protected function checkFile(string $filePath, array $sniffProperties = []): File
    {
        ...
        $sniffFile = $this->standardsDir . '/' . $standardName . '/Sniffs/' . $categoryName . '/' . $sniffName . 'Sniff.php';
